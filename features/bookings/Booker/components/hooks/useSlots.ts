...
import { useSlotReservationId } from "@bookph/core/features/bookings/Booker/useSlotReservationId";
...
import type { TIsAvailableOutputSchema } from "@bookph/core/trpc/server/routers/viewer/slots/isAvailable.schema";
