...
import { useIsPlatformBookerEmbed } from "@bookph/core/atoms/hooks/useIsPlatformBookerEmbed";
import dayjs from "@bookph/core/dayjs";
import PoweredBy from "@bookph/core/ee/components/PoweredBy";
import { useEmbedUiConfig } from "@bookph/core/embed-core/embed-iframe";
import { updateEmbedBookerState } from "@bookph/core/embed-core/src/embed-iframe";
import TurnstileCaptcha from "@bookph/core/features/auth/Turnstile";
import { useBookerStoreContext } from "@bookph/core/features/bookings/Booker/BookerStoreProvider";
import useSkipConfirmStep from "@bookph/core/features/bookings/Booker/components/hooks/useSkipConfirmStep";
...
import { scrollIntoViewSmooth } from "@bookph/core/lib/browser/browser.utils";
import { PUBLIC_INVALIDATE_AVAILABLE_SLOTS_ON_BOOKING_FORM } from "@bookph/core/lib/constants";
import { CLOUDFLARE_SITE_ID, CLOUDFLARE_USE_TURNSTILE_IN_BOOKER } from "@bookph/core/lib/constants";
