...
import processExternalId from "@bookph/core/app-store/_utils/calendars/processExternalId";
...
} from "@bookph/core/app-store/zod-utils";
import dayjs from "@bookph/core/dayjs";
import { scheduleMandatoryReminder } from "@bookph/core/ee/workflows/lib/reminders/scheduleMandatoryReminder";
...
import type { BookingDataSchemaGetter } from "@bookph/core/features/bookings/lib/dto/types";
import type {
  CreateRegularBookingData,
  CreateBookingMeta,
  BookingHandlerInput,
} from "@bookph/core/features/bookings/lib/dto/types";
import type { CheckBookingAndDurationLimitsService } from "@bookph/core/features/bookings/lib/handleNewBooking/checkBookingAndDurationLimits";
import { handlePayment } from "@bookph/core/features/bookings/lib/handlePayment";
import { handleWebhookTrigger } from "@bookph/core/features/bookings/lib/handleWebhookTrigger";
import { isEventTypeLoggingEnabled } from "@bookph/core/features/bookings/lib/isEventTypeLoggingEnabled";
import { BookingEventHandlerService } from "@bookph/core/features/bookings/lib/onBookingEvents/BookingEventHandlerService";
import type { BookingRescheduledPayload } from "@bookph/core/features/bookings/lib/onBookingEvents/types.d";
import { BookingEmailAndSmsTasker } from "@bookph/core/features/bookings/lib/tasker/BookingEmailAndSmsTasker";
import { getSpamCheckService } from "@bookph/core/features/di/watchlist/containers/SpamCheckService.container";
...
import AssignmentReasonRecorder from "@bookph/core/features/ee/round-robin/assignmentReason/AssignmentReasonRecorder";
...
import { getEventName, updateHostInEventName } from "@bookph/core/features/eventtypes/lib/eventNaming";
...
import { handleAnalyticsEvents } from "@bookph/core/features/tasker/tasks/analytics/handleAnalyticsEvents";
import type { UserRepository } from "@bookph/core/features/users/repositories/UserRepository";
import { UsersRepository } from "@bookph/core/features/users/users.repository";
...
import type { EventPayloadType, EventTypeInfo } from "@bookph/core/features/webhooks/lib/sendPayload";
import { getVideoCallUrlFromCalEvent } from "@bookph/core/lib/CalEventParser";
import { groupHostsByGroupId } from "@bookph/core/lib/bookings/hostGroupUtils";
import { shouldIgnoreContactOwner } from "@bookph/core/lib/bookings/routing/utils";
import { DEFAULT_GROUP_ID, ENABLE_ASYNC_TASKER } from "@bookph/core/lib/constants";
...
import { criticalLogger } from "@bookph/core/lib/logger.server";
import { getPiiFreeCalendarEvent, getPiiFreeEventType } from "@bookph/core/lib/piiFreeData";
...
import type { DestinationCalendar, Prisma, User, AssignmentReasonEnum } from "@bookph/core/prisma/client";
import {
  BookingStatus,
  SchedulingType,
...
import type { EventResult, PartialReference } from "@bookph/core/types/EventManager";
