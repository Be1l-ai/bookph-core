...
import { getBusyCalendarTimes } from "@bookph/core/features/calendars/lib/CalendarManager";
import type { HostRepository } from "@bookph/core/features/host/repositories/HostRepository";
import type { PrismaOOORepository } from "@bookph/core/features/ooo/repositories/PrismaOOORepository";
import { mergeOverlappingRanges } from "@bookph/core/features/schedules/lib/date-ranges";
import type { UserRepository } from "@bookph/core/features/users/repositories/UserRepository";
import logger from "@bookph/core/lib/logger";
import { raqbQueryValueSchema } from "@bookph/core/lib/raqb/zod";
import { safeStringify } from "@bookph/core/lib/safeStringify";
import type { PrismaAttributeRepository } from "@bookph/core/lib/server/repository/PrismaAttributeRepository";
import type { Prisma } from "@bookph/core/prisma/client";
import type { User, Booking, SelectedCalendar } from "@bookph/core/prisma/client";
import type { AttributeType } from "@bookph/core/prisma/enums";
import { RRTimestampBasis, RRResetInterval } from "@bookph/core/prisma/enums";
