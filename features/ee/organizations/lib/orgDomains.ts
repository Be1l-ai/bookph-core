...
import { IS_PRODUCTION, WEBSITE_URL, SINGLE_ORG_SLUG } from "@bookph/core/lib/constants";
import { ALLOWED_HOSTNAMES, RESERVED_SUBDOMAINS, WEBAPP_URL } from "@bookph/core/lib/constants";
