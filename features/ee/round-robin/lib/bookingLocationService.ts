import { getLocationValueForDB, OrganizerDefaultConferencingAppType } from "@bookph/core/app-store/locations";
import { CalVideoLocationType, type LocationObject } from "@bookph/core/app-store/locations";
