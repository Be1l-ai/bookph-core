import { WEBSITE_URL, IS_SELF_HOSTED, WEBAPP_URL } from "@bookph/core/lib/constants";
...
export const Codes = {
  react: {
    inline: ({
      ...
      return code`
import Cal, { getCalApi } from "@bookph/core/embed-react";
...
export default function MyApp() {
  ...
  "react-atom": {
    inline: ({
      ...
      return code`
import { BookerEmbed } from "@bookph/core/atoms";
