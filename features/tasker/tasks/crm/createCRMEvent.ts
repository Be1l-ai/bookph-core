import { appDataSchemas } from "@bookph/core/app-store/apps.schemas.generated";
import { RetryableError } from "@bookph/core/lib/crmManager/errors";
  ...
  try {
    ...
    for (const appSlug of Array.from(appInfoMap.keys())) {
      ...
      try {
        ...
        const CrmManager = (await import("@bookph/core/features/crmManager/crmManager")).default;
