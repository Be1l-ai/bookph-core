...
import { lockUser, LockReason } from "@bookph/core/features/ee/api-keys/lib/autoLock";
...
vi.mock("@calcom/features/ee/api-keys/lib/autoLock", async (importActual) => {
  const actual = await importActual<typeof import("@bookph/core/features/ee/api-keys/lib/autoLock")>();
  return {
...
vi.mock("@bookph/core/trpc/server/routers/viewer/workflows/util", () => ({
