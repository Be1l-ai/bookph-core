...
import { DEFAULT_PROMPT_VALUE, DEFAULT_BEGIN_MESSAGE } from "@bookph/core/features/calAIPhone/promptTemplates";
...
import { validateCustomEventName } from "@bookph/core/features/eventtypes/lib/eventNaming";
import type {
  FormValues,
  EventTypeSetupProps,
...
import { eventTypeBookingFields as eventTypeBookingFieldsSchema } from "@bookph/core/prisma/zod-utils";
